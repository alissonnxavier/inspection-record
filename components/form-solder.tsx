...
const FormSolder: React.FC<FormPressProps> = ({ tab }) => {
            ...
            <Card>
                ...
                <CardContent className="space-y-2">
                    ...
                    <div className="flex justify-between pb-4 space-y-1">
                        ...
                        <div>
                            <Label htmlFor="username">Solda:</Label>
                            <Select onValueChange={(value) => { setProcess(value)}}>
                                ...
                                <SelectContent>
                                    <SelectGroup>
                                        <SelectItem value="Rosca">Solda ponto</SelectItem>
                                        <SelectItem value="Escareado">Solda mig</SelectItem>
                                        <SelectItem value="Escareado">Solda tig</SelectItem>
                                    </SelectGroup>
                                </SelectContent>
                            </Select>
                        </div>
